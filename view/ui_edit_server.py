...
"}")
    ...
    def retranslateUi(self, EditServerWindow):
        ...
        self.securityComboBox_2.setItemText(3, _translate("EditServerWindow", "none"))
        self.levelLabel.setText(_translate("EditServerWindow", "Level"))
        self.userLabel.setText(_translate("EditServerWindow", "User"))
        self.hostLabel.setText(_translate("EditServerWindow", "Host(SNI)"))
        ...
        self.transportSettingsPushButton.setText(_translate("EditServerWindow", "Transport Settings"))
